...
const VersionView = ({ collection, global }) => {
    ...
    const [localeOptions] = useState(() => ((localization === null || localization === void 0 ? void 0 : localization.locales) ? localization.locales.map((locale) => ({ label: locale, value: locale })) : []));
