...
const Relationship = ({ field, version, comparison }) => {
    ...
    return (React.createElement("div", { className: baseClass },
        React.createElement(Label, null,
            ...
            field.label),
        React.createElement(ReactDiffViewer, { oldValue: typeof comparisonToRender !== 'undefined' ? String(comparisonToRender) : placeholder, newValue: typeof versionToRender !== 'undefined' ? String(versionToRender) : placeholder, splitView: true, hideLineNumbers: true, showDiffOnly: false })));
    return null;
};
