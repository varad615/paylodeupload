...
var CollapsibleContent = function (props) {
    ...
    var _b = (0, useCollapsible_1.default)(), rootClass = _b.rootClass, transCurve = _b.transCurve, transTime = _b.transTime, isOpen = _b.isOpen, initialHeight = _b.initialHeight;
    ...
    return (react_1.default.createElement(Tag, __assign({}, rest, { className: mergedClasses }),
